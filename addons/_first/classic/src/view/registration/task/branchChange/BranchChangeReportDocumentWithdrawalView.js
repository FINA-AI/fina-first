Ext.define('first.view.registration.task.branchChange.BranchChangeReportDocumentWithdrawalView', {
    extend: 'Ext.panel.Panel',

    xtype: 'branchChangeReportDocumentWithdrawal',
    ...
    controller: 'branchChangeReportDocumentWithdrawal',
