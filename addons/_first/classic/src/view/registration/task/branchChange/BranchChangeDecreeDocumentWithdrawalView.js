Ext.define('first.view.registration.task.branchChange.BranchChangeDecreeDocumentWithdrawalView', {
    extend: 'Ext.panel.Panel',

    xtype: 'branchChangeDecreeDocumentWithdrawal',

    controller: 'branchChangeDecreeDocumentWithdrawal',
    ...
    buttons: [{
        ...
        disabled: true,
        bind: {
            disabled: '{!(isRegistryActionEditor && decreeDocumentNumber && decreeDocumentDate)}'
        }
    }]
