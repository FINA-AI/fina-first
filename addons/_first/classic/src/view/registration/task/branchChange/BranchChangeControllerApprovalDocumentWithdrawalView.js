Ext.define('first.view.registration.task.branchChange.BranchChangeControllerApprovalDocumentWithdrawalView', {
    extend: 'Ext.panel.Panel',

    xtype: 'branchChangeControllerApprovalDocumentWithdrawal',

    controller: 'branchChangeControllerApprovalDocumentWithdrawal',
