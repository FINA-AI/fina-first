Ext.define('first.view.registration.task.cancellation.CancellationControllerApprovalCardView', {
    ...
    requires: [
        'Ext.button.Button',
        'first.view.registration.task.cancellation.CancellationControllerApprovalController',
    ],

    controller: 'cancellationControllerApproval',
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    ...
                    disabled: true,
                    bind: {
                        disabled: '{!existingReportCard.id || !isController}'
                    },
                    disabledTooltip: i18n.pleaseGenerateReportCardDisabledTooltip,
                }]
            }, {
