Ext.define('first.view.registration.task.cancellation.CancellationGeneralCardView', {
    ...
    requires: [
        ...
        'Ext.panel.Panel',
        'Ext.toolbar.Fill',
        'first.view.registration.task.cancellation.CancellationGeneralCardController',
    ...
    controller: 'cancellationGeneralCard',
    ...
    bbar: {
        ...
        items: ['->',
            {
                text: i18n.cancellationRejectAndLetterGeneration,
                handler: 'onGap',
                cls: 'finaSecondaryBtn',
                bind: {
                    disabled: '{inReview}'
            ...
            },
            {
                ...
                disabled: true,
                bind: {
                    disabled: '{disableSendToControllerButton || (fiAction.fina_fiCancellationIsLiquidatorRequired && !isAllLiquidatorReportCardGenerated)}',
                    hidden: '{!editMode}'
                },
                disabledTooltip: i18n.pleaseGenerateReportCardDisabledTooltip,
            },
