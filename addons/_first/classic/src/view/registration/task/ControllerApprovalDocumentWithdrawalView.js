Ext.define('first.view.registration.task.ControllerApprovalDocumentWithdrawalView', {
    extend: 'Ext.panel.Panel',

    xtype: 'controllerApprovalDocumentWithdrawal',

    controller: 'controllerApprovalDocumentWithdrawal',
