Ext.define('first.view.registration.task.branchChange.BranchChangeControllerApprovalController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.branchChangeControllerApproval',

    onApprove: function () {
        let me = this,
            data = this.getViewModel().get('fiAction');
