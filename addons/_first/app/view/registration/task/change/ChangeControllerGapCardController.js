Ext.define('first.view.registration.task.change.ChangeControllerGapCardController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.changeControllerGapCard',
    ...
    onBack: function () {
        ...
        if(data.fina_fiRegistryActionRedactingStatus === 'DECLINED'){
            ...
            data.fina_fiRegistryActionStepController = '5';
        }
