...
// ===========================
// EXTENDED ORGANIZATIONS (for Organization Registry module)
// ===========================

export const MOCK_ORGANIZATIONS_EXTENDED = [
  {
    id: '1',
    ...
    phone: '+995 32 244 5566',
    email: 'info@investholdings.ge',
    website: 'www.investholdings.ge',
    registrationNumber: 'ORG-2024-001',
    registrationDate: '2020-05-15T00:00:00Z',
    isActive: true,
    hasLicense: true,
    licenseNumber: 'LIC-ORG-2024-001',
    licenseType: 'General Business',
    licenseIssueDate: '2020-06-01T00:00:00Z',
    licenseExpiryDate: '2025-06-01T00:00:00Z',
  ...
  },
  {
    ...
    type: 'ORGANIZATION' as const,
    taxId: '400234567',
    name: 'Georgian Tech Solutions JSC',
    address: '45 Chavchavadze Avenue',
    city: 'Tbilisi',
    region: 'Tbilisi',
    organizationalForm: 'OJSC',
    phone: '+995 32 255 7788',
    email: 'info@geotech.ge',
    website: 'www.geotech.ge',
    registrationNumber: 'ORG-2023-078',
    registrationDate: '2019-11-20T00:00:00Z',
    isActive: true,
    hasLicense: true,
    licenseNumber: 'LIC-ORG-2023-045',
    licenseType: 'IT Services',
    licenseIssueDate: '2019-12-01T00:00:00Z',
    licenseExpiryDate: '2024-12-01T00:00:00Z',
  ...
  },
  {
    ...
    address: '78 Pekini Street',
    city: 'Tbilisi',
    region: 'Tbilisi',
    phone: '+995 595 345 678',
    email: 'n.maisuradze@gmail.com',
    isActive: true,
    hasLicense: true,
    licenseNumber: 'LIC-IND-2023-012',
    licenseType: 'Professional License',
    licenseIssueDate: '2023-01-10T00:00:00Z',
    licenseExpiryDate: '2028-01-10T00:00:00Z',
  ...
  },
  {
    ...
    type: 'ORGANIZATION' as const,
    taxId: '400345678',
    name: 'Batumi Trading Company LLC',
    address: '23 Rustaveli Street',
    city: 'Batumi',
    region: 'Adjara',
    organizationalForm: 'LLC',
    phone: '+995 422 27 5544',
    email: 'trade@batumi.ge',
    registrationNumber: 'ORG-2022-156',
    registrationDate: '2018-07-10T00:00:00Z',
    isActive: false,
    hasLicense: false,
    createdAt: '2018-07-10T15:30:00Z',
    createdBy: 'supervisor2',
  },
];
...
export const MOCK_BLACKLIST_ITEMS = [
  {
    id: 'BL-1',
    personType: 'INDIVIDUAL' as const,
    firstName: 'Suspicious',
    lastName: 'Person',
    personalId: '01045089999',
    birthDate: '1975-06-20T00:00:00Z',
    nationality: 'Unknown',
    reason: 'Suspected involvement in money laundering activities',
    sanctionType: 'FINANCIAL',
    source: 'National Bank of Georgia',
    status: 'ACTIVE',
    addedDate: '2023-05-15T00:00:00Z',
    addedBy: 'compliance_officer',
    expiryDate: '2025-05-15T00:00:00Z',
    notes: 'Subject to enhanced due diligence',
    createdAt: '2023-05-15T10:00:00Z',
  },
  {
    id: 'BL-2',
    personType: 'ORGANIZATION' as const,
    organizationName: 'Shady Enterprises LLC',
    taxId: '400999888',
    country: 'Georgia',
    reason: 'Links to sanctioned entities',
    sanctionType: 'TRADE',
    source: 'International Sanctions List',
    status: 'ACTIVE',
    addedDate: '2023-08-01T00:00:00Z',
    addedBy: 'admin',
    notes: 'All transactions prohibited',
  ...
  },
  {
    ...
    firstName: 'Removed',
    lastName: 'Individual',
    personalId: '01056078888',
    birthDate: '1980-11-10T00:00:00Z',
    nationality: 'Georgia',
    reason: 'Previously sanctioned - now cleared',
    sanctionType: 'FINANCIAL',
    source: 'National Bank of Georgia',
    status: 'REMOVED',
    addedDate: '2022-03-10T00:00:00Z',
    addedBy: 'compliance_officer',
    removedDate: '2024-01-15T00:00:00Z',
    removedBy: 'admin',
    removalReason: 'Sanctions lifted after review',
    notes: 'Subject cleared after investigation',
...
export const MOCK_ATTESTATIONS = [
  {
    id: 'ATT-1',
    candidateName: 'Levan Kapanadze',
    personalId: '01067089012',
    position: 'Chief Executive Officer',
    fiName: 'Georgian Microfinance LLC',
    fiCode: 'MFO-2024-001',
    applicationDate: '2024-01-10T00:00:00Z',
    status: 'RECOGNIZED',
    reviewDate: '2024-02-05T00:00:00Z',
    recognitionDate: '2024-02-10T00:00:00Z',
    certificateNumber: 'CERT-2024-001',
    validUntil: '2027-02-10T00:00:00Z',
    reviewer: 'attestation_committee',
    score: 95,
  ...
  {
    id: 'ATT-2',
    candidateName: 'Tamari Janelidze',
    personalId: '01078090123',
    position: 'Chief Financial Officer',
    fiName: 'Tbilisi Credit Union',
    fiCode: 'CRU-2024-002',
    applicationDate: '2024-02-15T00:00:00Z',
    status: 'UNDER_REVIEW',
  ...
  {
    id: 'ATT-3',
    candidateName: 'Giorgi Tsiklauri',
    personalId: '01089001234',
    position: 'Board Member',
    fiName: 'Capital Exchange Group',
    fiCode: 'FEX-2024-003',
    applicationDate: '2023-11-20T00:00:00Z',
    status: 'DECLINED',
    reviewDate: '2023-12-10T00:00:00Z',
    decisionDate: '2023-12-15T00:00:00Z',
    reviewer: 'attestation_committee',
    declineReason: 'Insufficient professional experience in the financial sector',
    notes: 'Candidate may reapply after gaining required experience',
...
export const MOCK_LICENSE_TYPES = [
  {
    id: 'LT-1',
    code: 'GEN_BUSINESS',
    name: 'General Business License',
    description: 'Standard business operations license',
    category: 'BUSINESS',
    validityPeriod: 60, // months
    renewalRequired: true,
    feeAmount: 500,
    feeCurrency: 'GEL',
    requiredDocuments: ['Business Plan', 'Financial Statements', 'Tax Certificate'],
    isActive: true,
  ...
  },
  {
    id: 'LT-2',
    code: 'MFO_LICENSE',
    name: 'Microfinance Organization License',
    description: 'License for microfinance operations',
    category: 'FINANCIAL',
    validityPeriod: 60,
    renewalRequired: true,
    feeAmount: 2000,
  ...
  },
  {
    ...
    description: 'License for financial sector professionals',
    category: 'PROFESSIONAL',
    validityPeriod: 60,
    renewalRequired: true,
    feeAmount: 300,
    feeCurrency: 'GEL',
    requiredDocuments: ['Education Certificate', 'Work Experience', 'Professional References'],
    isActive: true,
    createdAt: '2020-01-01T00:00:00Z',
    createdBy: 'admin',
  },
  {
    id: 'LT-4',
    code: 'IT_SERVICES',
    name: 'IT Services License',
    description: 'License for IT and technology services',
    category: 'TECHNOLOGY',
    validityPeriod: 36,
    renewalRequired: true,
    feeAmount: 800,
    feeCurrency: 'GEL',
    requiredDocuments: ['Technical Capability Assessment', 'Security Audit', 'Business Plan'],
    isActive: true,
    createdAt: '2020-01-01T00:00:00Z',
    createdBy: 'admin',
  },
  {
    id: 'LT-5',
    code: 'OLD_LICENSE',
    name: 'Deprecated License Type',
    description: 'This license type is no longer issued',
    category: 'BUSINESS',
    validityPeriod: 60,
    ...
    createdBy: 'admin',
    deactivatedAt: '2022-01-01T00:00:00Z',
    deactivatedBy: 'admin',
  },
];
...
export const MOCK_DASHBOARD_STATS = {
  ...
  // FI by Type
  fiByType: [
    { type: 'MFO', count: 4, label: 'Microfinance Organizations' },
    { type: 'CRU', count: 3, label: 'Credit Unions' },
    { type: 'FEX', count: 2, label: 'Foreign Exchange' },
    { type: 'LE', count: 1, label: 'Loan Exchange' },
  ],

  // FI by Status
  fiByStatus: [
    { status: 'ACCEPTED', count: 4, label: 'Accepted', color: '#4caf50' },
    { status: 'IN_PROGRESS', count: 3, label: 'In Progress', color: '#2196f3' },
    { status: 'GAP', count: 1, label: 'Gap', color: '#ff9800' },
    { status: 'DECLINED', count: 1, label: 'Declined', color: '#f44336' },
    { status: 'CANCELED', count: 1, label: 'Canceled', color: '#9e9e9e' },
  ],
  ...
  regionalDistribution: [
    { region: 'Tbilisi', count: 7 },
    { region: 'Adjara', count: 1 },
    { region: 'Kakheti', count: 1 },
