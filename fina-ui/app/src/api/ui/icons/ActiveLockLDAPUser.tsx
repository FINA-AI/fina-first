...
export const ActiveLockLDAPUser = () => {
  ...
  return (
    ...
    >
      ...
      />
      <g clipPath="url(#clip0_14235_615320)">
        <path
      ...
      <rect
        ...
        fill={iconsThemeColor(theme).secondary}
      />
      <g clipPath="url(#clip1_14235_615320)">
        <path
      ...
      <defs>
        <clipPath id="clip0_14235_615320">
          <rect
            width="12"
            height="12"
            fill="white"
        ...
        <clipPath id="clip1_14235_615320">
